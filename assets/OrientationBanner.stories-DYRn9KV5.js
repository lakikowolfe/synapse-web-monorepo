import{jA as a,jB as o,j as n}from"./iframe-CCwNk76Y.js";import"./index-Chi_LkuB.js";const m={title:"UI/OrientationBanner",component:a,render:t=>(localStorage.removeItem(o(t.name)),n.jsx(a,{...t}))},e={args:{name:"Teams",title:"Getting Started With Your Teams",text:"Teams allow you to easily manage groups of users to control access to projects, communicate with colleagues, and participate in challenges.",primaryButtonConfig:{text:"Search Teams",href:"https://www.synapse.org/TeamSearch:"},secondaryButtonConfig:{text:"Learn More About Teams",href:"https://help.synapse.org/docs/Teams.1985446029.html"}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'Teams',
...
}`,...e.parameters?.docs?.source}}};const c=["Demo"];export{e as Demo,c as __namedExportsOrder,m as default};
