...
`]);return de=function(){return e},e}Oe(d.createElement);var tt=function(t,n){var a=t.includes("top"),o=a?{top:0}:{bottom:0},s=t.includes("center")?{justifyContent:"center"}:t.includes("right")?{justifyContent:"flex-end"}:{};return l({left:0,right:0,display:"flex",position:"absolute",transition:Q()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:"translateY("+n*(a?1:-1)+"px)"},o,s)},nt=M(de()),R=16,rt=function(t){var n=t.reverseOrder,a=t.position,o=a===void 0?"top-center":a,s=t.toastOptions,r=t.gutter,i=t.children,u=t.containerStyle,c=t.containerClassName,v=Ie(s),m=v.toasts,h=v.handlers;return d.createElement("div",{style:l({position:"fixed",zIndex:9999,top:R,left:R,right:R,bottom:R,pointerEvents:"none"},u),className:c,onMouseEnter:h.startPause,onMouseLeave:h.endPause},m.map(function(g){var w=g.position||o,C=h.calculateOffset(g,{reverseOrder:n,gutter:r,defaultPosition:o}),j=tt(w,C),$=g.height?void 0:Ae(function(P){h.updateHeight(g.id,P.height)});return d.createElement("div",{ref:$,className:g.visible?nt:"",key:g.id,style:j},g.type==="custom"?N(g.message,g):i?i(g):d.createElement(le,{toast:g,position:w}))}))};function V({text:e,show:t,autohide:n}){const a=d.useRef(null);return x.jsx(ve,{children:t&&x.jsx(ge,{nodeRef:a,classNames:"SRC-card",timeout:n?{enter:500,exit:300}:{},children:x.jsx("div",{className:"SRC-modal",ref:a,children:e})})})}function q(){return x.jsx(rt,{containerClassName:"SynapseToastContainer",position:"bottom-center",children:e=>x.jsx(le,{toast:e,style:{...e.style,animation:e.visible?"fadeInUp 0.5s ease":"fadeOutDown 1s ease"}})})}const H=(e,t,n={})=>{const a=me("synToast-"),o=()=>{y.dismiss(a)},{title:s=void 0,primaryButtonConfig:r=void 0,secondaryButtonConfig:i=void 0,dismissOnPrimaryButtonClick:u=!1,dismissOnSecondaryButtonClick:c=!1}=n;if(r&&"onClick"in r&&u){const m=r.onClick;r.onClick=h=>{m(h),o()}}if(i&&"onClick"in i&&c){const m=i.onClick;i.onClick=h=>{m(h),o()}}let{autoCloseInMs:v=15e3}=n;return v===0&&(v=1/0),y(x.jsx(pe,{isGlobal:!1,onClose:o,variant:t??"info",show:!0,title:s,description:e,primaryButtonConfig:r,secondaryButtonConfig:i}),{id:a,className:"SynapseToastMessage",duration:v}),o};try{V.displayName="ToastMessage",V.__docgenInfo={description:`Generalization of a Material-style toast message used in a couple of places. This component is simple and
...
in SWC.`,displayName:"SynapseToastContainer",props:{}}}catch{}try{H.displayName="displayToast",H.__docgenInfo={description:"Displays a toast message. Requires one 'SynapseToastContainer' to be somewhere in the page.",displayName:"displayToast",props:{}}}catch{}export{q as S,V as T,H as d,y as t};
