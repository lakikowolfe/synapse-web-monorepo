...
`},S={sessionId:i,page:[{usersRequestText:"What is the weather like today?",usersRequestTimestamp:"2024-09-06T14:30:00Z",agentResponseText:"The weather is sunny with a high of 75°F.",agentResponseTimestamp:"2024-09-06T14:30:10Z"},{usersRequestText:"Can you tell me a joke?",usersRequestTimestamp:"2024-09-06T14:32:00Z",agentResponseText:"Why don’t scientists trust atoms? Because they make up everything!",agentResponseTimestamp:"2024-09-06T14:32:05Z"}],nextPageToken:void 0},E={jobId:":id",page:[{timestamp:1695567600,message:"Executing search on Synapse"}]},b={jobId:":id",page:[{timestamp:1695567700,message:"Gathering entity metadata"}]},f={jobId:":id",page:[{timestamp:1695567800,message:'<thinking>The metadata shows that the entity with ID syn9602623 is a Synapse project named "SearchIntegrationTest.Projecte475c6e8-414a-4842-b876-bf8232ce05d0". Its description contains the search term "e7b33c3a-2392-4ce7-a357-efa4612e4a41". The metadata ...'}]},_={jobId:":id",page:[]};let o=0;const j=(s=h(l.REPO_ENDPOINT))=>[n.rest.post(`${s}${c}`,async(a,t,e)=>t(e.status(201),e.json(d))),n.rest.post(`${s}${m}`,async(a,t,e)=>t(e.status(201),e.json(y))),n.rest.post(`${s}${p(i)}`,async(a,t,e)=>t(e.status(201),e.json(S))),A(g,a=>T(a),R,s),n.rest.post(`${s}${u(":id")}`,async(a,t,e)=>(o++,o==1?t(e.status(201),e.json(E)):o==5?t(e.status(201),e.json(b)):o==8?t(e.status(201),e.json(f)):t(e.status(201),e.json(_))))];export{j as g};
